        ...
        <AnimatePresence mode="popLayout">
          {getProjectsToDisplay().map((project) => (
            <motion.div
              ...
              className="group relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border border-gray-200 dark:border-gray-800 hover:border-blue-500/50 dark:hover:border-blue-500/50 rounded-2xl p-6 flex flex-col justify-between shadow-sm hover:shadow-xl dark:shadow-none hover:shadow-blue-500/10 transition-colors duration-300"
            >
              <div>
                <div className="mb-4">
                  {project.status === 'LIVE' ? (
                    ...
                    <span className="inline-flex items-center text-[10px] font-bold text-amber-600 dark:text-amber-300 bg-amber-50 dark:bg-amber-500/10 border border-amber-300/60 dark:border-amber-500/30 px-2.5 py-1 rounded-md uppercase tracking-wider shadow-[0_0_12px_rgba(245,158,11,0.25)] animate-pulse">
                      COMING SOON
                    </span>
                  )}
                </div>

                <h3 className="text-lg font-bold mb-2 text-gray-900 dark:text-gray-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
                  {project.title}
                </h3>
