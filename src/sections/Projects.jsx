...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 scroll-mt-20">
      ...
      {/* 🚀 Interactive Roadmap & Filter Buttons with Animations */}
      <div className="flex justify-center gap-3 mb-12">
        {[
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all duration-300 relative overflow-hidden ${
              filter === tab.id
                ? tab.id === 'Roadmap'
        ...
        {filteredProjects.map((project, index) => {
          ...
          return (
            <motion.div
              ...
              whileHover={isLive ? { scale: 1.03, y: -4 } : "hover"}
            ...
            >
              {/* ⚡ Unique Light Sweep / Shimmer Beam (Card par hover karte hi light pass hogi) */}
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  {/* Status Badges with Unique Animations */}
                  {isLive ? (
                    ...
                    /* 👑 Unique Rotating Border Badge for Coming Soon */
